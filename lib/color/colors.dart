...
import 'colors_quiz.dart';
import 'package:flutter_application_4/puzzlegame.dart'; // FruitsLearn sayfasının dosya yolunu ekleyin
import 'colors_learn.dart'; // FruitsTest sayfasının dosya yolunu ekleyin
import 'colors_games.dart'; // AnimalsGames sayfasının dosya yolunu ekleyin
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ColorsLearn()),
                      );
                    },
                    child: ClipRRect(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                ColorsGames()), // Burada AnimalsGames ekranını açıyoruz
                      );
                    },
                    child: ClipRRect(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ColorsQuiz()),
                      );
                    },
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(80.0),
