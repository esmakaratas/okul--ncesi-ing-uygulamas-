...
import 'body_quiz.dart';
import 'package:flutter_application_4/puzzlegame.dart'; // FruitsLearn sayfasının dosya yolunu ekleyin
import 'body_learn.dart'; // FruitsTest sayfasının dosya yolunu ekleyin
import 'body_games.dart'; // AnimalsGames sayfasının dosya yolunu ekleyin
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BodyLearn()),
                      );
                    },
                    child: ClipRRect(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                BodyGames()), // Burada AnimalsGames ekranını açıyoruz
                      );
                    },
                    child: ClipRRect(
